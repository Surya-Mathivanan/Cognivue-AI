      ...
      <div className="login-container-modern">
        ...
        <div className="login-panel-modern">
          <div className="login-glass-card">
            ...
            {/* HR Entry Divider */}
            <div className="hr-entry-divider">
              <span>Are you an HR professional?</span>
            </div>

            {/* HR Entry Button */}
            <button className="hr-entry-btn" onClick={handleHREntry}>
              ...
              <span>HR Entry</span>
              <svg className="google-btn-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
            </button>
